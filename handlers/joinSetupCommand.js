...
module.exports = (client) => {
    client.on(Events.GuildMemberAdd, async (member) => {
        try {
            ...
            // Создаём пустое изображение (новый Jimp)
            const image = await new Jimp(width, height, '#23272A');
            ...
            const avatar = (await Jimp.read(avatarURL)).circle(); // обрезаем в круг
            ...
            const discr = member.user.discriminator && member.user.discriminator !== '0'
